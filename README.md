...
Kanvas is a single-file web app that combines a whiteboard, a wiki, a kanban board, and four other views into one tool — with optional AI assistance powered by Claude.

🌐 **Live site:** [maestro-canvas.pages.dev](https://maestro-canvas.pages.dev)
...
Plus dark mode, mobile-responsive layout, and a context menu for changing colours, fonts, sizes, links, and tags on any element.
...
Your API key is stored only in your browser. Nothing is sent to any Kanvas server — calls go directly to Anthropic.
...
The live site is hosted on **Cloudflare Pages**, deployed by uploading the `index.html` file inside a folder.

To redeploy after changes:

1. Update `index.html`
2. Place it in a folder (any name)
...
3. Open Kanvas, click the settings cog
